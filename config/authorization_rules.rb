authorization do
  ...
  role :admin do
    ...
    has_permission_on :preferences_privacy, :to => :update
    has_permission_on :system_preferences, :to => :update
    has_permission_on :preferences_wifi, :to => [:update, :interface_status]
    has_permission_on :preferences_vpn, :to => :update
    has_permission_on :preferences_releases, :to => :update
