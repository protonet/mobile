...
class Socket {
  ...
  static function onReceive(data:String) {
    ...
    ExternalInterface.call("protonet.Emitter.trigger", "socket.receive", data);
  }
  
  static function onConnect(status:Boolean) {
    ExternalInterface.call("protonet.Emitter.trigger", "socket.connected", status);
  }
  ...
  static function main() {
    ...
    ExternalInterface.call("protonet.Emitter.trigger", "socket.initialized");
  }
}
