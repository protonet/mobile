...
fs.watchFile('/home/betahaus-scanner/scans', function (curr, prev) {
  ...
  child = exec('mv /home/betahaus-scanner/scans/* /home/protonet/dashboard/shared/files/channels/9', 
    function (error, stdout, stderr) {
      ...
      if (error !== null) {
        ...
        exec('chown protonet:protonet -R /home/protonet/dashboard/shared/files/channels/9');
        exec('chmod g+r -R /home/protonet/dashboard/shared/files/channels/9');
        setTimeout(function(){
          ...
          request.write(querystring.stringify({"channel_id":9, "message": "A new scan has arrived. Check the recent files on the right."}));
          request.end();
        }, 15000)
      }
  });
