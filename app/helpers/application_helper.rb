...
module ApplicationHelper
  ...
  def stylesheets
    ['/css/reset', '/css/general', '/css/header', '/css/subpage', '/css/logged_out', '/css/channels', '/css/meeps', '/css/form', '/css/text_extension', '/css/emoji', '/css/widget', '/css/pages/search', '/css/modal_window', '/css/context_menu', '/css/getting_started', '/css/pagination', '/css/files', '/css/users', '/css/apps']
  end
