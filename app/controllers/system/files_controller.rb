  ...
  class FilesController < ApplicationController
    ...
    def create_directory
      if params[:directory_name] && params[:file_path] && params[:channel_id]
        begin
          ...
          FileUtils.chmod(0751, SystemFileSystem.cleared_path(full_directory_path))
    ...
    def show
      if params[:file_path]
        ...
        if !mime_type.to_s.starts_with?("image/") && mime_type.to_s != "application/pdf" && mime_type.to_s != "text/plain"
